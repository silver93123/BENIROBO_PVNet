...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "use_pca_init": False,
    "axial_refine_axis": "none",
    "axial_refine_range_m": 0.02,
    "axial_refine_step_m": 0.0005,
...
_ICP_PARAM_KEYS = [
    ...
    "registration_type", "use_pca_init",
    "axial_refine_axis", "axial_refine_range_m", "axial_refine_step_m",
    "fgr_voxel_size_m", "fgr_normal_radius_factor",
